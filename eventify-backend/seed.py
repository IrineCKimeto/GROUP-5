...
with app.app_context():
    ...
    # Seed users
    admin_user = User(name="Admin User", email="admin@example.com", password="admin123", role="admin")
    regular_user = User(name="Regular User", email="user@example.com", password="user123", role="user")
